...
<script type="text/javascript">
	var _menus = {
		"menus" : [ {"menuid" : "1","icon" : "icon-sys","menuname" : "票务信息","menus" : [ 
		          {"menuid" : "31","menuname" : "在线订票","icon" : "icon-nav","url" : "Filmlist"},

			]
		}, {"menuid" : "8","icon" : "icon-sys","menuname" : "订单管理","menus" : [ 
		    {"menuid" : "21","menuname" : "我的订单","icon" : "icon-nav","url" : "userOrderlist"},

			]
		},  {"menuid" : "56","icon" : "icon-sys","menuname" : "用户信息","menus" : [
		      {"menuid" : "13","menuname" : "用户管理","icon" : "icon-users","url" : "demo.jsp"}
			]
		} 
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" split="true" border="false"
		...
		<span style="float: right; padding-right: 20px; font-size: 16px;"
			class="head">欢迎 <a href="#" id="loginOut">安全退出</a></span> <span
			style="padding-left: 10px; font-size: 16px;"><img
			src="img/blocks.gif" width="20" height="20" align="absmiddle" />
			欢迎使用电影院售票系统</span>
	</div>
	<div region="south" split="true"
		style="height: 30px; background: #D2E0F2;"></div>
	<div region="west" hide="true" split="true" title="用户导航"
