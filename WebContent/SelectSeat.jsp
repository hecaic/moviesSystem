          ...
          <h2 class="title"><a href="http://www.xwcms.net">选泽座位</a></h2>
            <div class="demo clearfix">
                ...
                <div class="booking_area">
                    ...
                    <p>类型：<span>${queryFilmId.getFilmLanguage()}</span>&nbsp;&nbsp;&nbsp;<span>${queryFilmId.getPlayType()}</span></p>
                    <p>影厅：<span>${queryFilmId.getRoomName()}</span></p>
                    <p>场次：<span>${querytime.getTime()}</span></p>
                    <p>座位：</p>
